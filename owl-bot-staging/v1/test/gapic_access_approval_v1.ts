...
describe('v1.AccessApprovalClient', () => {
    ...
    describe('invalidateApprovalRequest', () => {
        it('invokes invalidateApprovalRequest without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.accessapproval.v1.InvalidateApprovalRequestMessage());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.invalidateApprovalRequest as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAccessApprovalServiceAccount', () => {
        it('invokes getAccessApprovalServiceAccount without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.accessapproval.v1.GetAccessApprovalServiceAccountMessage());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.accessapproval.v1.AccessApprovalServiceAccount());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAccessApprovalServiceAccount as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
